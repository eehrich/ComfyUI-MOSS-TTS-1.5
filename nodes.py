...
class MOSSLoadModel:
    """Load / cache the MOSS-TTS processor + model."""
    ...
    def INPUT_TYPES(cls) -> dict[str, Any]:
        return {
            "required": {
                ...
                "text": ("STRING", {"default": "Hallo, das ist ein Test.", "multiline": True}),
                "language": (list(DEFAULT_LANGUAGES), {"default": "German"}),
                "instruction": ("STRING", {"default": "", "multiline": True,
                                              "placeholder": "Optional: Style/Direction hint (kein Referenz-Transkript!)"}),
                "audio_temperature": ("FLOAT", {"default": 1.7, "min": 0.1, "max": 3.0, "step": 0.05}),
                "audio_top_p": ("FLOAT", {"default": 0.8, "min": 0.0, "max": 1.0, "step": 0.01}),
                "audio_top_k": ("INT", {"default": 25, "min": 1, "max": 200, "step": 1}),
                "max_new_tokens": ("INT", {"default": 4096, "min": 256, "max": 16384, "step": 128}),
